...
const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=9543f74f7d3a7c10e512fe4330bc4ad1";

const initiallyDisplayedCurrencies = ["USD", "EUR", "GBP", "COP", "AUD"];
let baseCurrency;
...
let currencies = [{
    ...
    },
    {
        ...
        abbreviation: "COP",
        symbol: "\u0024",
        flagURL: "http://www.geonames.org/flags/l/co.gif"
    },
    {
        name: "Euro",
        abbreviation: "EUR",
